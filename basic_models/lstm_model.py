...
# Define a sequential Long Short-Term Memory (LSTM) neural network model
lstm_model = tf.keras.Sequential([
    tf.keras.layers.LSTM(128, activation="relu"),  # LSTM layer 1
    tf.keras.layers.LSTM(64, activation="relu"),   # LSTM layer 2
